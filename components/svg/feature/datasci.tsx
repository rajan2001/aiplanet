...
export function EosIconsDataScientist(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M17.885 23.553c0-.685.23-.922.615-.922c.396-.01.625.237.625.922V24H20v-.338c0-1.734-1.365-1.661-1.5-1.661c-.146 0-1.5-.083-1.5 1.661V24h.885Z"
      ></path>
    </svg>
  );
}
